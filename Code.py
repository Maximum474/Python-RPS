...
while True:
    ...
    choice = int(input("Pick one of the Choices: "))
    ...
    if choice == comp_choice:
        ...
        result = 'Paper wins this round' # HINT: Paper wins in this case
    elif (choice_name == 1 and  comp_choice == 3) or (choice == 3 and comp_choice == 1):
        result = 'Rock wins this round' # HINT: Rock wins in this case
    elif (choice_name == 3 and comp_choice == 2) or (choice == 2 and comp_choice == 3):
        result = 'Scissors wins this round' # HINT: Scissors wins in this case
